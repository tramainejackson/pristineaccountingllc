...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row pb-5" id="">
            ...
            <div class="col-12 mx-auto my-3" id="">
                ...
                <div class="" id="">
                    <table id="" class="table table-bordered table-responsive-sm">
                        ...
                        <tr>
                            ...
                            <td><a class="blue-text" href="{{ route('consult_contacts.edit', $consult->consultContact->id) }}">{{ $consult->consultContact->full_name() }}</a></td>
            ...
            @else
                <div class="col-8 text-center mb-5 mx-auto">
                    <h2 class="h2 h2-responsive">This consult request has been completed and an invoice hase been created. To download the completed invoice, click on the link below</h2>
                </div>
                <div class="col-12 text-center">
                    <a class="btn btn-outline-blue-grey" href="{{ asset('storage/documents/' . $consult->invoice->file_name . '.docx') }}" download="{{ $consult->consultContact->full_name() . ' Invoice - ' . $consult->invoice->invoice_number }}">Download Invoice - {{ $consult->invoice->invoice_number < 10 ? '00' .$consult->invoice->invoice_number : '0' . $consult->invoice->invoice_number }}</a>
                </div>
            @endif
        </div>
    </div>
