										...
										<tr>
											<td align="left" style="color: #aaaaaa; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
												<div style="line-height: 24px;">
													...
													<h2 style="color: whitesmoke;">Pristine Accounting LLC</h2>
								...
								<tbody>
									<tr>
										<td align="left" style="color: #3d3d3d; font-size: 22px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;" class="align-center main-header">
											<p>Thank you {{ $consult_contact->first_name }} for reaching our to me and hopefully trusting me with helping you with your financial needs. Your
												request is for {{ $consult_contact->consultRequest->service }} services.</p>
										</td>
									</tr>
									...
									<tr>
										<td align="left" style="color: #3d3d3d; font-size: 22px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;" class="align-center main-header">
											...
											@if($consult_contact->consultRequest->service == 'bookkeeping')
												<p>Bookkeeping is the most basic of all accounting functions. Bookkeeping involves maintaining accurate and updated records of all of your company’s financial activity. This includes bank records, tax filings, payroll records, and purchase and sale records. These records are essential to regulatory compliance. Proper bookkeeping makes other accounting functions, such as audits, payroll, and tax preparation, much simpler and less time consuming.</p>
											@elseif($consult_contact->consultRequest->service == 'tax_prep')
												<p>Yearly individual and commercial tax preparation can be extremely complex. Records and submissions must be prepared carefully in order to minimize your risk of unforeseen tax liabilities, fees, or audits. We can help prepare your taxes with easy from 1040s to 990s and everything in between.</p>
											@elseif($consult_contact->consultRequest->service == 'financial_ananlysis')
												<p>It is wise to conduct periodic review and analysis of your company’s financial performance. These reviews are typically called audits, and are an important part of regulatory compliance. Additionally, financial analysis can provide valuable insight into your company’s financial health which can help you make sound decisions for the future.</p>
											@elseif($consult_contact->consultRequest->service == 'budget')
												<p>Budgeting can be essential to making sure an individual or company stays on the right track with expenses and revenue. Budgeting quantifies the expectation of revenue and expenses that a business wants to achieve for a future period. Forecasting estimates the number of revenue that will be achieved in future periods.</p>
											@elseif($consult_contact->consultRequest->service == 'budget')
												<p>Helping individuals prepare monthly budgets to maintain their personal expenses and monthly income.</p>
											@elseif($consult_contact->consultRequest->service == 'invoicing')
												<p>Prepare monthly invoicing and contract preparation.</p>
											@else
												<p> We can provides clients, such as companies and individuals, with services that help them analyze financial information so that they can make important business decisions.</p>
											@endif
							...
							<tbody><tr>
								<td align="center">
									<table align="center" border="0" cellpadding="0" cellspacing="0">
										<tbody><tr>
											<td align="center">
												<span style="font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;color: #5caad2; text-decoration: none;font-weight:bold;" href="">Ashley Clark-Jackson</span>
											</td>
										</tr>
										</tbody></table>
								</td>
