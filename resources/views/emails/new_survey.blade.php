													...
													<table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;">
														...
														<tr style="border-collapse:collapse;">
															<td align="center" class="es-m-txt-c" style="padding:0;Margin:0;padding-top:40px;padding-bottom:40px;">
																<!--[if mso]><a href="https://pristineaccountingllc.com/survey/{{ $consult_contact->survey_id }}" target="_blank">
																	<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" stripoVmlButton href="https://pristineaccountingllc.com/survey/{{ $consult_contact->survey_id }}"
																				 style="height:74px;v-text-anchor:middle;width:198px;" arcsize="0%" stroke="f" fillcolor="#2f8112">
																		<w:anchorlock></w:anchorlock>
																		<center style='color:#ffffff;font-family:Oswald, sans-serif;font-size:18px;font-weight:700;'>GO TO SURVEY</center>
																	</v:roundrect></a>
																<![endif]-->
																<!--[if !mso]><!-- --><span class="msohide es-button-border" style="border-style:solid;border-color:#1B2A2F;background:#2F8112;border-width:0px;display:inline-block;border-radius:0px;width:auto;mso-hide:all;"><a href="https://pristineaccountingllc.com/survey/{{ $consult_contact->survey_id }}" class="es-button" target="_blank" style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Oswald, sans-serif;font-size:20px;color:#FFFFFF;border-style:solid;border-color:#2F8112;border-width:25px 40px 25px 40px;display:inline-block;background:#2F8112;border-radius:0px;font-weight:bold;font-style:normal;line-height:24px;width:auto;text-align:center;">GO TO SURVEY</a></span>
																<!--<![endif]--></td>
														</tr>
														<tr style="border-collapse:collapse;">
															<td align="left" style="padding:0;Margin:0;padding-bottom:20px;"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:20px;font-family:'Open Sans', sans-serif;line-height:30px;color:#262626;">If the button doesn't work, copy and paste the following link in your browser:</p></td>
														</tr>
														<tr style="border-collapse:collapse;">
